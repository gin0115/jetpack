...
function jetpack_notify_postauthor( $emails, $comment_id ) {
	...
	if ( '' == $comment->comment_author ) { // phpcs:ignore WordPress.PHP.StrictComparisons.LooseComparison
		$from = "From: \"$blogname\" <$wp_email>";
		if ( '' != $comment->comment_author_email ) { // phpcs:ignore WordPress.PHP.StrictComparisons.LooseComparison
